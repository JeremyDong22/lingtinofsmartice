// Admin Question Templates CRUD Page - Manage questionnaire prompts
// v2.0 - Moved from parent route to /manage sub-route
...
export default function QuestionTemplatesManagePage() {
  const { user } = useAuth();
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold text-gray-900">问卷管理</h1>
        </div>
        <UserMenu />
      </header>
