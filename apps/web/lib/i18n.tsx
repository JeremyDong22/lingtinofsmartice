...
const dict: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    'dashboard.feedbackSummaryNeg': '{0} 个问题需关注，{1} 桌提到',
    'dashboard.feedbackSummaryPos': '{0} 项好评，{1} 桌提到',
    'dashboard.feedbackSummarySug': '{0} 条改善建议',
  ...
  'en': {
    ...
    'dashboard.feedbackSummaryNeg': '{0} issues need attention, mentioned by {1} tables',
    'dashboard.feedbackSummaryPos': '{0} positive items, mentioned by {1} tables',
    'dashboard.feedbackSummarySug': '{0} improvement suggestions',
