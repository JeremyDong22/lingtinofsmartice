...
const dict: Record<Locale, Record<string, string>> = {
  'zh-CN': {
    ...
    // Feedback Loop Cards
    'feedbackLoop.visit': '桌访',
    'feedbackLoop.visitCoverage': '覆盖率 {0}%',
    'feedbackLoop.visitCount': '{0}次桌访',
    'feedbackLoop.negativeCount': '{0}条负面',
    'feedbackLoop.review': '复盘',
    'feedbackLoop.reviewCompletion': '完成率 {0}%',
    'feedbackLoop.reviewDays': '{0}/{1}天',
    'feedbackLoop.avgDuration': '均{0}分钟',
    'feedbackLoop.action': '行动',
    'feedbackLoop.actionItems': '{0}条建议',
    'feedbackLoop.highPriority': '{0}条高优',
    'feedbackLoop.execution': '执行',
    'feedbackLoop.resolutionRate': '解决率 {0}%',
    'feedbackLoop.resolved': '已解决 {0}/{1}',
    'feedbackLoop.trendUp': '↑',
    'feedbackLoop.trendDown': '↓',
    'feedbackLoop.trendFlat': '→',
    'feedbackLoop.noData': '暂无数据',
    // Action Items Drill Down
    'drillDown.pendingItems': '未解决行动项',
    'drillDown.days': '{0}天',
    'drillDown.evidence': '原声证据',
    'drillDown.noItems': '暂无未解决项',
    'drillDown.category.dish_quality': '菜品',
    'drillDown.category.service_speed': '速度',
    'drillDown.category.staff_attitude': '态度',
    'drillDown.category.environment': '环境',
    'drillDown.category.other': '其他',
    'drillDown.priority.high': '高',
    'drillDown.priority.medium': '中',
    'drillDown.priority.low': '低',
  },
  'en': {
    // BottomNav (manager)
    'nav.chat': 'Chat',
    ...
    // Feedback Loop Cards
    'feedbackLoop.visit': 'Visits',
    'feedbackLoop.visitCoverage': '{0}% coverage',
    'feedbackLoop.visitCount': '{0} visits',
    'feedbackLoop.negativeCount': '{0} negative',
    'feedbackLoop.review': 'Review',
    'feedbackLoop.reviewCompletion': '{0}% done',
    'feedbackLoop.reviewDays': '{0}/{1} days',
    'feedbackLoop.avgDuration': 'avg {0}min',
    'feedbackLoop.action': 'Actions',
    'feedbackLoop.actionItems': '{0} items',
    'feedbackLoop.highPriority': '{0} high priority',
    'feedbackLoop.execution': 'Resolution',
    'feedbackLoop.resolutionRate': '{0}% resolved',
    'feedbackLoop.resolved': '{0}/{1} resolved',
    'feedbackLoop.trendUp': '↑',
    'feedbackLoop.trendDown': '↓',
    'feedbackLoop.trendFlat': '→',
    'feedbackLoop.noData': 'No data',
    // Action Items Drill Down
    'drillDown.pendingItems': 'Pending Action Items',
    'drillDown.days': '{0}d',
    'drillDown.evidence': 'Voice Evidence',
    'drillDown.noItems': 'No pending items',
    'drillDown.category.dish_quality': 'Dish',
    'drillDown.category.service_speed': 'Speed',
    'drillDown.category.staff_attitude': 'Attitude',
    'drillDown.category.environment': 'Environment',
    'drillDown.category.other': 'Other',
    'drillDown.priority.high': 'High',
    'drillDown.priority.medium': 'Med',
    'drillDown.priority.low': 'Low',
  },
};
