...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    date: '2026-03-07',
    roles: ['manager'],
    title: '问卷 v3 + 反馈摘要 + 复盘闭环',
    items: [
      {
        title: '问卷调查升级为对话式措辞',
        howToUse: '录音页「桌访」模式下，问卷提示卡片的问题措辞更自然，更接近日常对话，减少机械感。',
        value: '问得更自然，顾客更愿意聊，反馈质量更高。',
      },
      {
        title: '反馈摘要横幅',
        howToUse: '看板顶部新增结构化摘要：问题数+桌数+Top 关键词 / 好评数 / 建议数，一行看清今天的反馈全貌。',
        value: '不用逐条翻反馈，一眼抓住今天最重要的信息。',
      },
      {
        title: '复盘闭环卡片',
        howToUse: '看板新增「复盘」卡片，展示当日复盘状态和待办跟进情况，提醒你今天是否已完成复盘。',
        value: '养成每日复盘习惯，行动建议不遗漏。',
      },
    ],
  },
  {
    ...
    date: '2026-03-07',
    roles: ['administrator'],
    title: '执行追踪 + 总览升级 + 洞察优化',
    items: [
      {
        title: '执行追踪面板',
        howToUse: '总览页顶部新增「执行数据」卡，展示各门店桌访数、复盘率、连续复盘天数，一览执行情况。',
        value: '一眼看出哪些门店在坚持执行、哪些需要提醒。',
      },
      {
        title: '总览 3 级展开',
        howToUse: '总览页从门店网格升级为品牌→门店→问题三级折叠结构，点击逐层展开查看详情。',
        value: '多品牌场景下信息更有层次，大规模门店也不凌乱。',
      },
      {
        title: '洞察品牌分组',
        howToUse: '洞察页「顾客」和「画像」Tab 的反馈数据按品牌分组展示，折叠查看各品牌门店详情。',
        value: '品牌之间的差异一目了然，管理决策更有针对性。',
      },
      {
        title: '反馈信息层级优化',
        howToUse: '洞察页建议和需关注列表支持展开/折叠，反馈卡片信息层级更清晰。',
        value: '信息不再堆叠，需要时展开，不需要时收起。',
      },
    ],
  },
  {
    ...
    title: 'Pure Float Glass 全站视觉升级',
    items: [
      {
        title: '全站视觉风格升级',
        howToUse: '所有页面已升级为 Pure Float Glass 玻璃拟态设计，卡片、导航、按钮风格统一，无需额外操作。',
        value: '界面更现代、更清爽，操作体验更舒适。',
      },
      {
        title: '图标全面升级',
        howToUse: '原先的 emoji 图标已全部替换为 SVG 矢量图标，显示更清晰统一。',
        value: '不同手机上显示效果一致，不再因系统 emoji 不同而困惑。',
      },
      {
        title: '录音双通道上传',
        howToUse: '录音完成后系统同时通过两个通道上传，无需额外操作。如果一个通道失败，另一个仍会成功。',
        value: '录音丢失概率大幅降低，网络不好也更放心。',
      },
      {
        title: 'PWA 自动更新',
        howToUse: '系统检测到新版本后自动刷新页面，无需手动清理缓存或重新加载。',
        value: '始终使用最新版本，不再因为缓存问题看到旧页面。',
      },
    ],
  },
  {
